...
export default function RegisterForm() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const res = await axios.post('https://server.albaniarentaltourism.com/api/register', formData, {
  ...
  return (
    <div className="flex min-h-screen w-full mt-[-5%] items-center justify-center bg-background px-4 pb-12 sm:px-6 lg:px-8">
      <div className="w-full max-w-md space-y-4">
        <div>
          <h2 className="mt-2 text-center text-3xl font-bold tracking-tight text-black">Register</h2>
