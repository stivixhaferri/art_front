...
const page = () => {
  return (
    <div>
<div className='lg:pt-5 pt-[20%] pb-[5%] flex'>
        ...
        >
          Udhëtimi drejt <br /> Përsosmërisë
            ...
            <img src="about.svg" className='lg:w-[60%] w-full mx-auto' alt="" />
    ...
    <div className='flex lg:flex-row  flex-col'>
      <div className='lg:w-[50%] w-full'>
        <img src="wrengle.png" className='w-full h-full object-cover' alt="" />
      </div>
      <div className='lg:w-[50%] w-full py-[5%] px-[5%] bg-black flex flex-col'>
        <span className='text-[#FF0000] font-semibold lg:text-xl text-md'>Kush Jemi Ne</span>
        <h1 className='text-white lg:text-[80px] text-[50px] font-bold py-5'>Albanian Rental<br /> Tourism</h1>
        ...
        <Link href={'/register'} className='bg-[#FF0000] justify-center text-white px-5 py-3 lg:w-[35%] w-full mt-5 text-center font-semibold'>Account</Link>
      </div>
    </div>
    ...
    <div className='lg:w-[50%] w-full py-[5%] px-[5%] bg-[#FF0000] flex flex-col'>
        <span className='text-white font-semibold lg:text-xl text-md'>Misioni Ynë</span>
        <h1 className='text-white lg:text-[80px] text-[50px] font-bold py-5'>OUR<br /> MISSION</h1>
        <p className='text-white text-[20px]  py-5'>
        ...
        <Link href={'/contact'} className='bg-black text-center justify-center font-semibold text-white px-5 py-3 lg:w-[35%] w-full mt-5'>Na Kontaktoni</Link>
      </div>
      <div className='lg:w-[50%] w-full'>
        <img src="rt.png" className='w-full h-full object-cover' alt="" />
      </div>
