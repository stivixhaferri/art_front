...
const Nav = ({token}) => {
  ...
  return (
    <nav className=" bg-[#F7F7F7] z-[10000] w-full flex relative justify-between items-center mx-auto px-8 h-20">
  {/* logo */}
  <div className="inline-flex lg:w-[33%] w-[50%]">
    <a className="_o6689fn" href="/">
      <div className="hidden md:block">
        ...
        <img src="/logo.png" className='w-[10%] ml-[10%] object-contain' alt="" />
      </div>
      <div className="block md:hidden">
      <img src="/logo.png" className='w-[20%] ml-[10%] object-contain' alt="" />
      </div>
    </a>
  </div>
  {/* end logo */}
  {/* search bar */}
  <div className="lg:flex hidden justify-center items-center lg:w-[33%]">
    {/* <div className="inline-block">
      <div className="inline-flex justify-center nx-auto items-center max-w-full">
        <button
  ...
  {/* end search bar */}
  {/* login */}
  <div className="flex-initial lg:w-[33%] w-[50%]">
    <div className="flex justify-end items-center relative">
      <div className="flex mr-4 items-center">
        {user ? (<>
        
            <Link
          className="lg:inline-block hidden py-2 px-3 hover:bg-gray-200 rounded-full"
          href={'/post'}
        >
  ...
  <DropdownMenuContent className="z-[10001]">
    <DropdownMenuLabel className="focus:outline-none">My Account </DropdownMenuLabel>
    <DropdownMenuSeparator />
    {user ? (<>
        <DropdownMenuItem>
    ...
    <DropdownMenuItem className="lg:hidden">
        <Link href={'/post'}>Post Your Car</Link>
    </DropdownMenuItem>
    <DropdownMenuItem className='lg:hidden'>
    <Link href={'/my_cars'} >My Cars</Link>
    </DropdownMenuItem>
