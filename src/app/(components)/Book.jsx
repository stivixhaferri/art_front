    ...
    <div className=" static mx-auto mt-10 bg-white rounded-lg overflow-hidden border-[0.5px]" style={{position: 'sticky !important'}}>
      ...
      <form className="py-4 px-6" onSubmit={handleSubmit}>
        ...
        <div className="flex items-center justify-center mb-4">
              <div onClick={handlePaymentSuccess} className={`w-full py-2 text-[10px] px-4 rounded text-white focus:outline-none focus:shadow-outline flex items-center text-center justify-center ${isDateRangeValid ? 'bg-red-600 hover:bg-red-800 flex items-center text-center justify-center' : 'flex items-center text-center justify-center bg-gray-400 cursor-not-allowed'}`}>
                Book Appointment
              </div>
        </div>
