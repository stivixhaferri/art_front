  ...
  return (
    <Accordion type="single" collapsible className="w-full">
      <AccordionItem value="item-1">
        <AccordionTrigger className="lg:text-[25px] text-start">Çfarë duhet të bëj pas hyrjes në sistem?</AccordionTrigger>
        <AccordionContent className="lg:text-[18px] text-start">
          Pas hyrjes në sistem, do të shihni dy mundësi të reja në shiritin e sipërm: Post Your Car dhe My Cars
        </AccordionContent>
      </AccordionItem>
      <AccordionItem value="item-2">
        <AccordionTrigger className="lg:text-[25px] text-start">Si të postoj makinën time për qira?</AccordionTrigger>
        <AccordionContent className="lg:text-[18px] text-start">
      ...
      <AccordionItem value="item-3">
        <AccordionTrigger className="lg:text-[25px] text-start">Çfarë është seksioni &quot;My Cars&quot;?</AccordionTrigger>
        <AccordionContent className="lg:text-[18px] text-start">
      ...
      <AccordionItem value="item-4">
        <AccordionTrigger className="lg:text-[25px] text-start">Si kryhet pagesa për mjetet e dhëna me qira?</AccordionTrigger>
        <AccordionContent className="lg:text-[18px] text-start">
      ...
      <AccordionItem value="item-5">
        <AccordionTrigger className="lg:text-[25px] text-start">Kush mund të shohë listat e makinave të mia?</AccordionTrigger>
        <AccordionContent className="lg:text-[18px] text-start">
      ...
      <AccordionItem value="item-6">
        <AccordionTrigger className="lg:text-[25px] text-start">Çfarë duhet të bëj nëse has ndonjë problem me platformën?</AccordionTrigger>
        <AccordionContent className="lg:text-[18px] text-start">
